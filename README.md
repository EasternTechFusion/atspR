...
| One-size-fits-all model choice | `cross_validate()` supports multiple model types (**Linear Regression (lm) / Generalized Additive Model (gam) / Random Forest (rf)/ Decision Tree (dt)**) |
